...
class MCircleIndicator @JvmOverloads constructor(
    ...
    defStyleAttr: Int = 0
) : FrameLayout(context, attrs, defStyleAttr), MIndicator<FrameLayout> {
    ...
    init {
        mPointLeftRightPadding = MDisplayUtil.dp2px(5f, context.resources)
        mPointTopBottomPadding = MDisplayUtil.dp2px(15f, context.resources)
    }
